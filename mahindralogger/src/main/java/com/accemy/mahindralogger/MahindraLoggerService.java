...
public interface MahindraLoggerService {
    ...
    String PROD_ENDPOINT = "http://mapi.mahindrasyouv.com/"; //Live Environment
    String PROD_ENDPOINT_SSL = "https://mapi.mahindrasyouv.com/"; // LIVE SSL
...
//    })
    ...
    class Creator {
        ...
        public static MahindraLoggerService  newMahindraLoggerService(final boolean isProd,final boolean isSsl) {
            ...
            Retrofit retrofit = new Retrofit.Builder()
                    .baseUrl(isProd ? (isSsl ? MahindraLoggerService.PROD_ENDPOINT_SSL : MahindraLoggerService.PROD_ENDPOINT) : MahindraLoggerService.UAT_ENDPOINT)
                    .client(client)
